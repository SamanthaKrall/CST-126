...
<html>
    ...
    <h1 align="center">Welcome back to the Frog Blog!</h1>
    	<?php echo "<h1 align='center' style='color:forestgreen'>" . $_SESSION['userName']; ?>
    	<br/>
    	<div class="topnav">
    	...
    	<section>
    		<nav>
    			<ul>
    				...
    				<br><br>
    				<li><a href="readBlog.php"><button>Read Blogs Fully</button></a></li>
    				<br><br>
    				<li><a href="searchUsers.php"><button>Search Users</button></a></li>
    			</ul>
    		</nav>
    		<article>
